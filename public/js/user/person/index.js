 ...
 $(function(){
    $.ajax({
        ...
        success: function(e){
            var json = {
                base_info : {
                    nickname : "714553561@qq.com",
                    avatar : "/images/1.png",
                    email : "714553561@qq.com",
                    mobile : "",
                    email_validate : true,
            ...
            if (json.base_info.identity_validate) {
                $('.base-info .identity-validate').text('身份已验证');
            } else {
                $('.base-info .identity-validate').text('身份未验证');
            }
            ...
            $.each(json.recommend_job, function(n, value){
                ...
                $('.recommend-resume .table .list-body-l2').append(html);
            })
        },
        error: function(e){
            //
