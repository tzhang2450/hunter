...
@section("style")
    ...
    <link rel="stylesheet" type="text/css" href="/css/person-safe.css">
@endsection
                    ...
                    <div class="row insidepage pb100">
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-orange btn-lg font-sm" href="">修改</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-orange btn-lg font-sm" href="">验证</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-7 col-sm-9">
                                <div class="safety-info">
                                    <h4 class="font-bg title-main">安全手机 18746287648<span><i class="glyphicon glyphicon-exclamation-sign"></i>未验证</span></span></h4>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-7 col-sm-9">
                                <div class="safety-info">
                                    <h4 class="font-bg title-main">个人身份认证</h4>
                                    <div class="font-sm title-sub title-orange">身份认证增加企业信你的信任度</div>
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-orange btn-lg font-sm" href="">认证</a>
                                </div>
                            </div>
                        </div>
...
@endsection
@section("self-script")
    <script type="text/javascript" src="/js/user/person/safe.js"></script>
@endsectio