                    ...
                    <div class="row insidepage pb100">
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-safety-enterprise btn-lg font-sm" href="">修改</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-safety-enterprise btn-lg font-sm" href="">验证</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-safety-enterprise btn-lg font-sm" href="">认证</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb0 safetycenter">
                            ...
                            <div class="col-xs-3 col-sm-2 safety-btn">
                                <div class="row">
                                    <a class="btn btn-safety-enterprise btn-lg font-sm" href="">绑定</a>
                                </div>
                            </div>
                        </div>
...
@endsection
@section("self-script")
    <script type="text/javascript" src="/js/user/enterprise/safe.js"></script>
@endsection