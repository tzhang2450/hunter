            ...
            <div class="row">
                ...
                <main class="col-md-10 main-content">
                    <div class="row insidepage pb50">
                        <h4 class="font-lg padding-30 padding-bottom-20">服务诉求管理</h4>
                        <div class="warning">
                            ...
                            <div class="table">
                                <div class="hidden-xs list-title row mb0">
                                    <div class="col-sm-5">
                                        <div class="row chackbox20-total">
                                            ...
                                            <div class="col-xs-11 col-sm-11 font-list-title">意向机构</div>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="row mb0">
                                ...
                                <div class="hidden-sm hidden-md hidden-lg list-title row mb0">
                                    <div class="row chackbox20-total">
                                        ...
                                        <div class="col-xs-4 font-list-title">意向机构 / 服务</div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="row mb0">
                                                ...
                                                <div class="col-xs-11 col-sm-11">
                                                    <div class="list-info">
                                                        <h4 class="font-bg title-main">贵州中和会计师事务所</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="row mb0">
                                                ...
                                                <div class="col-xs-2 col-sm-2">
                                                    <div class="font-sm list-info single-line detail"><a class="font-sm" href="/user/enterprise-appeal-detail.html">详情</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@endsection
@section("self-script")
    <script type="text/javascript" src="/js/user/enterprise/appeal.js"></script>
@endsection
