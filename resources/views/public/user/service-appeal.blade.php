                                ...
                                <div class="hidden-xs list-title row mb0">
                                    <div class="col-sm-5">
                                        <div class="row chackbox20-total">
                                            ...
                                            <div class="col-xs-11 col-sm-11 font-list-title">申请诉求企业</div>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="row mb0">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row mb0">
                                                ...
                                                <div class="col-xs-2 col-sm-2">
                                                    <div class="font-sm list-info single-line detail"><a class="font-sm" href="/user/service-appeal-detail.html">详情</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
