            ...
            <div class="row">
                ...
                <main class="col-md-10 main-content">
                    <div class="row insidepage">
                        <h4 class="font-lg padding-30 padding-bottom-20">机构认证</h4>
                        <div class="warning">
                        ...
                        <form id="edit-profile" class="form-horizontal padding-lr-30">
                            ...
                            <div class="row control-group">
                                <label class="col-xs-12 col-sm-3 control-label"><span>*</span>机构全称</label>
                                <div class="col-xs-12 col-sm-3 controls">
                                    <input type="text" class="real-name form-control" placeholder="请输入机构全称">
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                            ...
                            <div class="row control-group">
                                <label class="col-xs-12 col-sm-3 control-label"><span>*</span>上传相关资质</label>
                                <div class="col-xs-12 col-sm-9 controls">
                                    <a class="btn btn-default" href=""><i class="glyphicon glyphicon-plus-sign"></i>上传相关资质（需原件扫描）</a>
                                    <input type="hidden" class="input-medium id-frontend">
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
...
@endsection
@section("self-script")
    <script type="text/javascript" src="/js/user/service/validate.js"></script>
@endsection