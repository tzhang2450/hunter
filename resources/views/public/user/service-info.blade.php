            ...
            <div class="row">
                ...
                <main class="col-md-10 main-content">
                    <div class="row insidepage pb50">
                        <h4 class="font-lg padding-30 padding-bottom-20">最新资讯</h4>
                        <div class="warning">
                        ...
                        <div class="add-button">
                            <a class="btn btn-add btn-lg" href="/user/service-pub-news.html"><i class="glyphicon glyphicon-plus"></i> 添加最新资讯</a>
                        </div>
...
@endsection
@section("self-script")
    <script type="text/javascript" src="/js/user/service/info.js"></script>
@endsection