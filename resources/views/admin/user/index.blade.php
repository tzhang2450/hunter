                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover  dataTables-example">
                            ...
                            @if(!count($userList))
                                <tr>
                                    <td colspan="5"><div class="text-center">暂无数据</div></td>
                                </tr>
                            @else
                        ...
                        @if(count($userList))
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="DataTables_Table_0_info" role="alert" aria-live="polite" aria-relevant="all">显示 1 到 {{ count($userList) }} 项，共 {{ $total }} 项</div>
                                </div>
                                <div class="col-sm-6">
