                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        ...
                        @if(count($programList))
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="DataTables_Table_0_info" role="alert" aria-live="polite" aria-relevant="all">显示 1 到 {{ count($programList) }} 项，共 {{ $total }} 项</div>
                                </div>
                                <div class="col-sm-6">
